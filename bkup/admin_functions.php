...
/* ----------------------------------------------- */
function display_councils_dropdown()
{
	global $wpdb;
	$output = "";
	$rows = $wpdb->get_results("SELECT * FROM ".	$GLOBALS['council_table']);
	$output .= '<select name="council_name">';
	foreach($rows as $row)
	{ 
...
<div id="assign_div" >
	...
	<button id="add_new_user">ADD NEW USER</button> Or Select the existing user in our system and assign them as head. <br /> <br />
<table>
<tr>
<th>
...
$rows = $wpdb->get_results("SELECT * FROM ".$council_table); ?>
<h2 align="center"> Select Council to lists their members </h2>
<select name="council_name_list" id="council_name_list" style="text-align:center;">
<?php
foreach($rows as $row)
{ ?>
	<option value="<?php echo $row->id; ?>"> <?php echo $row->council_name; ?></option>
...
<div id="manage_head_div" style="margin-top:30px;height:600px;position:relative;" >
	<h2 align="center" style="font-weght:bold;color:maroon;"><?php echo $status_msg; ?></h2>
<div id="list_div">
<h1 align="center"> List of Council Members</h1>
<table cellspacing="0" cellpadding="20" border="1">
<tr>
<th> Council Name </th>
<th> Email ID </th>
...
<?php
	...
	<br /><br />
<button id="manage_heads">Add Council Member</button>
<br /><br />
<div id="assign_div" >
	<form name="assignhead" method="post" id="assignhead" >
