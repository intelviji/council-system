 ...
 * Plugin URI: http://www.atechitservices.com
 * Description: plugin to manage DOCM Council System and its members
 * Version: 1.0
 * Author: Vijayalakshmi Satish
 * Author URI: http://www.atechitservices.com
 * License: GPL
 */
 
 
/*  Copyright 2017  Vijayalakshmi Satish  (email : support@atechitservices.com) */
...
function council_admin_menu() {  
    ...
    add_menu_page(__('Council Management System','menu-council'), __('Council Management System','menu-council'), 'manage_options', 'cms-slug', 'cms_page_func' );
...
add_submenu_page('cms-slug', __('Manage Members','menu-council'), __('Manage Members','menu-council'), 'manage_options', 'cms-manage-members', 'cms_manage_mem_func');
...
function cms_page_func()
{
	...
	echo '<a href="">Manage Council Heads </a><br />';
	echo '<a href="">Manage Council Members </a><br />';
...
council team.<br />";
			...
			$headers[] = "Cc:support@atechitservices.com";
